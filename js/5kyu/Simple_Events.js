...
function Event() { this.pool = new Set() }
Event.prototype.subscribe = function(f) { this.pool.add(f) }
Event.prototype.unsubscribe = function(f) { this.pool.delete(f) }
Event.prototype.emit = function(...args) { this.pool.forEach(e => e(...args)) }
